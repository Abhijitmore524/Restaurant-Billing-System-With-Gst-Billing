...
class Bill_App:
    def __init__(self, root):
        ...
        bath_lbl = Label(F2, text="Butter Chicken", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=0, column=0, padx=10, pady=10,
                                                                                                                        sticky=W)
        bath_txt = Entry(F2, width=10, textvariable=self.Butter_Chicken, font=("times new roman", 16, "bold"), bd=5,relief=SUNKEN).grid(row=0, column=1, padx=10,
                                                                                                                              pady=10)
        ...
        Face_W_lbl = Label(F2, text="Plain Stream Rice", font=("times new roman", 16, "bold"), bg=bg_color,fg="lightgreen").grid(row=2, column=0, padx=10, pady=10,
                                                                                                                         sticky=W)
        Face_W_txt = Entry(F2, width=10, textvariable=self.Plain_Stream_Rice, font=("times new roman", 16, "bold"), bd=5,relief=SUNKEN).grid(row=2,
                                                                                                                            column=1, padx=10, pady=10)

        Hair_s_lbl = Label(F2, text="Palak Paneer", font=("times new roman", 16, "bold"), bg=bg_color,fg="lightgreen").grid(row=3, column=0, padx=10, pady=10, sticky=W)
        Hair_s_txt = Entry(F2, width=10, textvariable=self.Palak_Paneer, font=("times new roman", 16, "bold"), bd=5,relief=SUNKEN).grid(row=3, column=1, padx=10, pady=10)

        Hair_g_lbl = Label(F2, text="Veg Biryani", font=("times new roman", 16, "bold"), bg=bg_color,fg="lightgreen").grid(row=4, column=0, padx=10, pady=10, sticky=W)
        Hair_g_txt = Entry(F2, width=10, textvariable=self.Veg_Biryani, font=("times new roman", 16, "bold"), bd=5,relief=SUNKEN).grid(row=4, column=1, padx=10, pady=10)
